...
mergeTrees = []
for i in range(0,20):
    path = "./vertical-swap-outlier.cdb/data/member_"+str(i)+".vti"
...
fig.savefig("./clustermap_path_outlier.svg",transparent=True,bbox_inches='tight',pad_inches=0)
...
plt.axis('off')
plt.colorbar(pos,ax=[ax],location='left',shrink=0.85)
fig.savefig("./clustermap_deform_outlier.svg",transparent=True,bbox_inches='tight',pad_inches=0)
