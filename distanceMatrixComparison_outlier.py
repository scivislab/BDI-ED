...
mergeTrees = []
for i in range(0,20):
    path = "./test_datasets/branchVSconstrained_outlier/test_MB/test_MB_"+str(i)+".vti"
...
dm_file = open("./test_datasets/branchVSconstrained_outlier/matrix_wasserstein_cpp.txt",'r')
...
plt.colorbar(pos,ax=[ax],location='right',shrink=0.85)
fig.savefig("./clustermap_branch_outlier.svg",transparent=True,bbox_inches='tight',pad_inches=0)
#plt.show()
...
#fig.colorbar(pos, ax=ax)
plt.colorbar(pos,ax=[ax],location='right',shrink=0.85)
fig.savefig("./clustermap_constrained_outlier.svg",transparent=True,bbox_inches='tight',pad_inches=0)
#plt.show()
...
#fig.colorbar(pos, ax=ax)
plt.colorbar(pos,ax=[ax],location='right',shrink=0.85)
fig.savefig("./clustermap_wasserstein_outlier.svg",transparent=True,bbox_inches='tight',pad_inches=0)
